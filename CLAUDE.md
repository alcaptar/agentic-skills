...
| **Lo que se leyo un dia** | `docs/12-factor.md`, `docs/maturity-map.md`, `docs/research-agent-loops.md` | Quien quiera saber de donde salio una decision. **Fechado: no se actualiza**, y lo que cite puede estar ya retirado |
