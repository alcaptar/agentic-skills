...
_TABLE: list[tuple[Step, Outcome, dict[str, int], tuple[Step, RunState, int]]] = [
    ...
    (Step.CATCH_UP, Outcome.FAILED, {}, (Step.CATCH_UP, RunState.OPEN, 30)),
    (
        Step.CATCH_UP,
        Outcome.FAILED,
        {"catch_up_retries": Budgets().catch_up_retries},
        (Step.CATCH_UP, RunState.BLOCKED_CI_CONFLICT, 0),
    ),
    (Step.CATCH_UP, Outcome.HYGIENE_REJECTED, {}, (Step.CATCH_UP, RunState.OPEN, 30)),
    (
        Step.CATCH_UP,
        Outcome.HYGIENE_REJECTED,
        {"catch_up_retries": Budgets().catch_up_retries},
