...
_TABLE: list[tuple[Step, Outcome, dict[str, int], tuple[Step, RunState, int]]] = [
    ...
    (Step.CATCH_UP, Outcome.DISCARDED, {}, (Step.CATCH_UP, RunState.OPEN, 0)),
    (Step.CATCH_UP, Outcome.HYGIENE_REJECTED, {}, (Step.CATCH_UP, RunState.OPEN, 0)),
    (Step.CATCH_UP, Outcome.HYGIENE_REJECTED, {"hygiene_retries": 1}, (Step.CATCH_UP, RunState.OPEN, 0)),
    (
        Step.CATCH_UP,
        Outcome.HYGIENE_REJECTED,
        {"hygiene_retries": 2},
        (Step.CATCH_UP, RunState.BLOCKED_HYGIENE, 0),
    ),
    ...
    (
        ...
        Outcome.CALL_NOT_MEASURED,
        {},
        (Step.CATCH_UP, RunState.ABORTED_UNMEASURED_CALL, 0),
    ),
