...
class TestHowTheConflictResolverCallIsInvoked:
    @pytest.fixture
    def argv(self) -> Argv:
        return Argv(ConflictResolverInvocationMother.of_one_conflicted_file().argv)
    ...
    def test_the_schema_that_travels_is_the_one_the_payload_generates_and_not_another(self, argv: Argv) -> None:
        assert json.loads(argv.value_of("--json-schema")) == ResolutionReportPayload.json_schema()
    ...
    def test_the_brief_travels_on_standard_input_and_not_in_the_argv(self) -> None:
        invocation = ConflictResolverInvocationMother.of_one_conflicted_file()
    ...
    def test_the_cwd_the_process_needs_is_the_worktree_of_the_conflict(self) -> None:
        assert ConflictResolverInvocationMother.of_one_conflicted_file().cwd == MergeConflictMother.WORKTREE


class TestTheConflictDataThatTravelsWithTheBrief:
    def test_it_names_the_issue_the_slice_the_repo_the_branch_the_base_and_the_conflicted_paths(self) -> None:
        text = ConflictResolverInvocationMother.of_one_conflicted_file().text
    ...
    def test_the_brief_opens_the_prompt_so_the_conflict_data_reads_as_an_appendix(self) -> None:
        assert ConflictResolverInvocationMother.of_one_conflicted_file().text.startswith(ConflictResolverBrief.TEXT)
